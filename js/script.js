...
function Barreiras(altura, largura, abertura, espaco, notificarPonto) {
    this.pares = [
        ...
        new parDeBarreira (altura, abertura, largura + espaco * 4)
    ]
...
function Progresso() {
    ...
    this.atualizarProgresso = pontos => {
...
function FlappyBird () {
    ...
    const barreiras = new Barreiras(altura, largura, 230, 430,
        () => progresso.atualizarProgresso(++pontos))
...
// const barreiras = new Barreiras (700, 1200, 230, 400)
